    ...
    return (
        <>
         <div className="flex flex-wrap">
          <div className="md:w-1/2 w-auto flex h-screen justify-center items-center bg-gray-100">
           
            <div className="pt-12 justify-center items-center mx-auto w-auto md:w-full lg:max-w-md  md:max-w-md md:px-0 px-4">
              ...
              <div className="bg-white shadow w-full rounded-md">
                ...
                <div className="text-center hover:text-red-700">
                  <NavLink to="/register">Register as Member </NavLink>
                </div>
