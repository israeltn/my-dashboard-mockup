...
//   }
  ...
  return (
    <div>
      <main>
        <div className="pt-6 px-4 bg-whites">
          <div className="mt-4 w-full grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-4">
            {/* Total section */}
            <div className="shadow bg-white border-2 border-violet-600 rounded-lg p-4 sm:p-6 xl:p-8 ">
            ...
            <div className="shadow bg-white border-2 border-red-500 rounded-lg p-4 sm:p-6 xl:p-8 ">
            ...
            <div className="shadow bg-white border-2 border-green-500  rounded-lg p-4 sm:p-6 xl:p-8 ">
          ...
          <td className="px-6 py-4 whitespace-nowrap">
                                     <div className="text-sm font-medium text-gray-900">00</div>
                                </td>
          <td className="px-6 py-4 whitespace-nowrap">
            <div className="flex items-center">
              <div className="items-center">
                ...
                <div className="text-sm text-gray-500">email@gmail.com</div>
              </div>
            </div>
          </td>
          ...
          <td className="px-6 py-4 whitespace-nowrap">
            ...
            <div className="text-sm text-gray-500">iCREATE Design Agency LTD.</div>
          </td>
