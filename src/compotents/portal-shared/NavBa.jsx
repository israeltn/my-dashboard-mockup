        ...
        <div className="px-3 py-1 lg:px-5 lg:pl-3">
          <div className="flex items-center justify-between">
            ...
            <div className="flex items-center">
              ...
              <div className="bg-green-400 rounded-sm hover:bg-green-600 cursor-pointer">
                <button
                  type="button"
                  onClick=''
              ...
              <div className="flex-1 h-full px-3 bg-white">
                <ul className="space-y-2 pb-2">
                  ...
                  <li>
                    ...
                    >
                      <svg
                        className="w-6 h-6 text-gray-500 group-hover:text-green-400 transition duration-75"
                        fill="currentColor"
                        viewBox="0 0 20 20"
                        xmlns="http://www.w3.org/2000/svg"
                      >
                  ...
                  {/* <li>
                   ...
                   <svg className="w-6 h-6 text-gray-500 flex-shrink-0 group-hover:text-green-400 transition duration-75"  xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6">
                ...
                <li>
                    ...
                    >
                      <svg
                        ...
                        stroke-width="1.5"
                        stroke="currentColor"
                        className="w-6 h-6 text-gray-500 flex-shrink-0 group-hover:text-green-400 transition duration-75"
                      >
                        <path
                  ...
                  <li>
                    ...
                    >
                      ...
                      <span className="ml-3">Loan Applications</span>
                    </Link>
                  </li>                 
                  ...
                  <li>
                    ...
                    >
                      ...
                      <span className="ml-3">Deposit/Savings</span>
                    </Link>
                  </li>
                  ...
                  <li>
                    ...
                    >
                      ...
                      <span className="ml-3 flex-1 whitespace-nowrap">Withdrawal</span>
